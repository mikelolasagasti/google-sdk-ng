...
%prep
%goprep
# remove all modules but iam
find %{_builddir}/google-cloud-go-iam-v%{version}/* -depth -type d -not -path '*/iam*' -not -path '*/_build*' -exec rm -rf {} \;
rm doc.go
mv iam/* .
