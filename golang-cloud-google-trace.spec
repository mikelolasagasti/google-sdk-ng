...
%prep
%goprep
# remove all modules but trace
find %{_builddir}/google-cloud-go-trace-v%{version}/* -depth -type d -not -path '*/trace*' -not -path '*/_build*' -exec rm -rf {} \;
rm doc.go
mv trace/* .
